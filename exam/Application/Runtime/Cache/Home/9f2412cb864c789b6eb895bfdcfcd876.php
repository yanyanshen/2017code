            ...
            <!-- E header -->
                        <div id="bd" class="panel">
                            <div id="panel1" class="panel-body">
                                ...
                                <a href="<?php echo U('Home/Index/think',array('userid'=>$userid));?>">
                                    <input class="btn btn-lg btn-success start_exam"  type="button" value="点击开始答题" style="color:#fdfd88;width: 100%;margin-top:10px;"/>
                                </a>
                                <a href="<?php echo U('Home/Index/result');?>">
                                    <input class="btn btn-lg btn-success"  type="button" value="点击查看选择题结果" style="color:#fdfd88;width: 100%;margin-top:10px;"/>
                                </a>
                                <a href="<?php echo U('Home/Index/short');?>">
                                    <input class="btn btn-lg btn-success"  type="button" value="点击查看简答题结果" style="color:#fdfd88;width: 100%;margin-top:10px;"/>
                                </a>
                            </div>
                        </div>
                 </div>
