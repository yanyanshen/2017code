...
<div class="formbody">
    <div id="usual1" class="usual">
        <div id="tab1" class="tabson">
            ...
            <form action="<?php echo U('Pay/Test/test_add');?>" method="post" id="form1" enctype="multipart/form-data">
                <input type="text" name="qimg"  value=""/>
                <ul class="forminfo">
                    <li>
                        <label>问题<b>*</b></label>
        ...
        $('#form1').ajaxSubmit(function(res) {
            if(res.status==0){
                ...
                layer.msg(res.info,{icon:6,time:2000},function(){
                    location="<?php echo U('Pay/Test/addtestshow');?>";
                });
            }
