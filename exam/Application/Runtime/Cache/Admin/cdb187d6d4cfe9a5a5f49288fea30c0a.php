...
<head>
    ...
    <!--<link rel="stylesheet" type="text/css" href="/test/Public/Admin/js/webuploader/webuploader.css" />-->
    ...
    <script type="text/javascript" src="/test/Public/Admin/js/jquery.form.js"></script>
    <!--<script type="text/javascript" src="/test/Public/Admin/js/webuploader/webuploader.js"></script>-->
    <!--<script type="text/javascript" src="/test/Public/Admin/js/upload.js"></script>-->
...
<div class="formbody">
    <div id="usual1" class="usual">
        <div id="tab1" class="tabson">
            <form action="<?php echo U('Admin/Test/addtest');?>" id="form1" method="post" enctype="multipart/form-data">
                    <ul class="forminfo">
                        <li>
                            <label>导入Excel表<b>*</b></label>
                            <input style="width: 200px;height:30px;padding-top: 8px;float: left;" name="excelname" type="file" />
                            <p style="float: left;padding-top: 10px;color:red">插入的表格的后缀必须是.xls</p>
                        </li>
