    ...
    <div id="usual1" class="usual">
        <div id="tab1" class="tabson">
            ...
            <form action="<?php echo U('Pay/Test/editorAddData');?>" method="post" id="form1" enctype="multipart/form-data">
                ...
                <input type="hidden" class="right_answer"  value="<?php echo ($data1["right_answer"]); ?>"/>
                <ul class="forminfo">
                    <li>
                        <label>问题<b>*</b></label>
                    ...
                    <li>
                        ...
                        <div class="vocation">
                            <select class="select2" name="type">
                                <?php if($data1["type"] == 0): ?><option value="0" selected>单选题</option>
                                    <option value="1">多选题</option><?php endif; ?>
                                <?php if($data1["type"] == 1): ?><option value="0" >单选题</option>
                                    <option value="1" selected>多选题</option><?php endif; ?>
                            </select>
                        </div>
                    </li>
                    <li>
                    ...
                    <li class="input">
                        <label>A选项<b>*</b></label>
                        <input name="aname" type="text" class="dfinput input" value="<?php echo ($data1['a']); ?>"  style="width:352px;"/>

                    </li>
                    <li class="input">
                        <label >B选项<b>*</b></label>
                        <input name="bname" type="text" class="dfinput input" value="<?php echo ($data1["b"]); ?>"    style="width:352px;"/>
                    </li>
                    <li class="input">
                        <label class="label">C选项<b>*</b></label>
                        <input name="cname" type="text" class="dfinput input" value="<?php echo ($data1["c"]); ?>"    style="width:352px;"/>

                    </li>
                    <li class="input">
                        <label>D选项<b>*</b></label>
                        <input name="dname" type="text" class="dfinput input" value="<?php echo ($data1["d"]); ?>"    style="width:352px;"/>
                    ...
                    <?php if($data1["ifimg"] == 1): ?><li class="img">
                            ...
                            <div class="usercity" style="border:3px dashed #e6e6e6;width:352px;height:300px;position: relative;margin-bottom: 15px">
                                <p id="preview1" >
                                    <img id="imghead1" width="230px" height="220px"  border=0 src='<?php echo ($server); ?>/uploads/TestPic/<?php echo ($data1["picurl"]); echo ($data1["picname"]); ?>'>
                                </p><span></span>
                    ...
                    <li>
                        ...
                        <input name="right_answer" type="text" class="dfinput right" value="<?php echo ($data1["right_answer"]); ?>" placeholder="选一个答案，例如选 A"   style="width:352px;text-align: left;outline: none"/>
                    </li>
                    <li><label>&nbsp;</label>
