...
//            })
            $('#form1').submit(function(){
                if(validate1.form()){
                    $.post("<?php echo U('Pay/changePwd');?>",$('#form1').serialize(),function(res){
                        if(res.status==1){
                            layer.msg('修改密码成功',{time:2000,icon:6},function(){
                                location="<?php echo U('Pay/changeInfo');?>";
                            })
                        }else{
...
//                if(validate2.form()){
//                    $.post("<?php echo U('Pay/changeMobile');?>",$('#form2').serialize(),function(res){
//                        if(res.status==1){
