...
<body style="background:url(/test/Public/Admin/images/topbg.gif) repeat-x;">

    <div class="topleft">
    <a href="index.html" target="_top"><img src="/test/Public/Admin/images/logo.png" title="系统首页" /></a>
    </div>
        
 <!--    <ul class="nav">
 <li>
     <a href="main.html" target="rightFrame" class="selected">
         <img src="/test/Public/Admin/images/icon01.png" title="工作台" />
     <h2>工作台</h2>
     </a>
 </li>
    ...
    <div class="topright">
    <ul>
    <li><span><img src="/test/Public/Admin/images/help.png" title="帮助"  class="helpimg"/></span><a href="#">帮助</a></li>
    <li><a href="#">关于</a></li>
