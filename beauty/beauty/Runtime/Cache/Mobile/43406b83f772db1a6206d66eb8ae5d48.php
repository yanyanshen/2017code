...
<!--loading页结束-->
            ...
            <div class="lists clearfloat">
                <div class="top clearfloat">
                    <ul>
                        <li>默认</li>
                        <li>
                            <?php if($_SESSION['beauty_']['price']== 'saleprice'): ?><a class="actived" href="<?php echo U('Search/smilarGoods',array('price'=>'saleprice','keywords'=>$keywords));?>">价格</a>
                                <?php else: ?>
                                <a  href="<?php echo U('Search/smilarGoods',array('price'=>'saleprice','keywords'=>$keywords));?>">价格</a><?php endif; ?>
                            <i class="iconfont icon-xiala"></i>
                        </li>
                        <li>
                            <?php if($_SESSION['beauty_']['sale']== 'salenum'): ?><a class="actived" href="<?php echo U('Search/smilarGoods',array('sale'=>'salenum','keywords'=>$keywords));?>">销量优先</a>
                                <?php else: ?>
                                <a  href="<?php echo U('Search/smilarGoods',array('sale'=>'salenum','keywords'=>$keywords));?>">销量优先</a><?php endif; ?>
                            <i class="iconfont icon-xiala"></i>
                        </li>
                    </ul>
                </div>
	...
	<!--<script type="text/javascript" src="/Public/Mobile/list/map/jery-1.8.3.min.map" ></script>-->
	<!--<script src="/Public/Mobile/list/map/mui.min.map"></script>-->
	<!--<script src="/Public/Mobile/list/map/others.map"></script>-->
	<!--<script type="text/javascript" src="/Public/Mobile/list/map/hmt.map" ></script>-->
...
<script>
    ...
    function index(id){
        ...
        var id=id?id:1;
        $.get("<?php echo U('Search/smilarGoods');?>",{"p":id,"keywords":keywords},function(res){
            $('#insert').html(res);
        })
    }
</script>