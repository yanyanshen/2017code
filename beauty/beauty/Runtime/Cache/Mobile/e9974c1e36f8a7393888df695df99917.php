...
<html>
 <head> 
  <title>品牌大全</title> 
  <meta charset="utf-8" /> 
  <meta name="keywords" content="鞋子品牌,鞋子品牌大全,鞋子品牌排名" /> 
  <meta name="description" content="拍鞋网鞋子品牌大全为您提供世界鞋子品牌排名信息，可以了解到比较好的鞋子品牌有哪些，女鞋子品牌有哪些，男生鞋子品牌有哪些，真皮的鞋子品牌哪种好等信息。" /> 
 ...
 <body> 
  ...
  <script>var PX_HELP_DATA=['416148489@qq.com','i2jioq5184gbv9ts2qudnsgth4',['touch','brand','index'],'2015/09/15 16:00:05',0,false]; var DOMIN = {MAIN:"http://m.paixie.net",HELP:"http://help.paixie.net",TUAN:"http://tuan.paixie.net",WAP:"http://wap.paixie.net",UNION:"http://union.weixiaodian.com",VIPSHOP:"http://go.paixie.net"};</script> 
  <script>
   ...
   <div class="com-header-area" style="display:none"> 
    <header> 
     ...
     <ul> 
      ...
      <li> <a rel="nofollow" class="buy" href="http://m.paixie.net/cart/"> <span class="number spec-num">3</span> </a> </li> 
     </ul> 
    </header> 
    <div class="search"> 
     <form action="http://m.paixie.net/s.php" method="post"> 
      <span class="input"><input type="text" name="keyword" value="" /></span> 
...
$(document).ready(function() {
    ...
    <link type="text/css" rel="stylesheet" href="/Public/Mobile/css/index.1.1.css?1" />
    <script src="/Public/Mobile/js/index.1.1.js?1"></script>
    <div class="com-title"> 
     <a title="返回" href="javascript:history.back();void(0)" class="return"></a> 
     <a title="菜单" href="javascript:void(0);" class="home_menu"> <span></span> </a> 品牌 
    </div> 
    ...
    <div class="p-area" id="js-brands"> 
     <div class="p-search-box" id="js-searchbox"> 
      <form action="/s.php" method="post"> 
       <input name="keyword" class="p-search" id="js-search" type="search" value="" placeholder="搜索商品" /> 
       <input class="p-submit" type="submit" value="搜索" /> 
       <div class="clearboth"></div> 
      </form> 
     </div> 
     <div class="p-tag"> 
      <a href="<?php echo U('Mobile/Category/index');?>">分类</a>
      <a href="<?php echo U('Mobile/Category/brand');?>" class="current">品牌</a>
     </div> 
     <h2 id="rr" name="rr">热门品牌</h2> 
     <ul class="brandslist"> 
        <?php if(is_array($brandGoods)): $i = 0; $__LIST__ = $brandGoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$date): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('GoodsList/brandList',array('bid'=>$date['id']));?>">
                <img src="/Upload/logo<?php echo ($date['blogopath']); echo ($date['blogoname']); ?>" /><?php echo ($date["bname"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
     </ul> 
