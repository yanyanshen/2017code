...
<div class="com-content">
    ...
    <div class="com-content-area" id="js-com-content-area">
        ...
        <div class="com-title">
            <a title="返回" href="<?php echo U('Mobile/Index/index');?>" class="return"></a>
            <a title="菜单" href="javascript:void(0);" class="home_menu"> <span></span> </a> 找商品
        </div>
                ...
                <div class="p-conright">
                    ...
                    <div class="js-con-4" style="display:none;">
                        ...
                        <div class="p-two-title">
                            <p style="color:#; ">洁面</p>
                            <ul class="p-three-title">
                                <?php if(is_array($five1)): $i = 0; $__LIST__ = array_slice($five1,0,3,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><li> <a href="<?php echo U('Mobile/Goods/goodsdetail',array('gid'=>$data['gid']));?>">
                                        <img src="/Uploads/<?php echo ($data['imageurl']); echo ($data['imagename']); ?>" alt="" />
                                        <span style="font-size: 0.06rem;color: #000000 "><?php echo (mb_substr($data['goodsname'],0,10,utf8)); ?></span> </a> </li><?php endforeach; endif; else: echo "" ;endif; ?>
                                <div class="clearboth"></div>
                            </ul>
