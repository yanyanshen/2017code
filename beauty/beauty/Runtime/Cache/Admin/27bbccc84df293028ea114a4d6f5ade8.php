        ...
        <div id="tab1" class="tabson">
            ...
            <form action="" method="post" id="form1" enctype="multipart/form-data">
                <?php if(is_array($commentList)): $i = 0; $__LIST__ = $commentList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><ul class="forminfo">
                        ...
                        <li><label>回复内容<b>*</b></label><textarea  id="" name="content" cols="30" rows="10"  style="width:600px;height:200px;border:1px solid #cccccc;"><?php echo ($val["response"]); ?></textarea></li>
