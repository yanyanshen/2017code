...
<form action="<?php echo U('Pay/Golds/search');?>" method="get" id="form1">
    <ul class="seachform">
    ...
    <table class="tablelist">
        ...
        <td style="font-size: 10px;"><?php echo ($val["ml"]); ?>毫升</td>
        ...
        <td style="font-size: 10px;" class="par">
            <a href="<?php echo U('Pay/Golds/editor',array('gid'=>$val['id']));?>"  class="tablelink">编辑&nbsp;&nbsp;&nbsp;&nbsp;</a>
...
<script type="text/javascript">
    ...
    $(function(){
        $('.click').click(function(){
            gid=$(this).attr('gid');
            cur=$(this);
            $.post("<?php echo U('Pay/Golds/updateshow');?>",{gid:gid},function(response){
                if(response.status){
                    if(response.info==1){
                        cur.text('下架');
