...
<div class="formbody">
    <div id="usual1" class="usual">
        <div id="tab1" class="tabson">
            <form action="<?php echo U('Pay/Golds/addAct');?>" id="add" method="post" enctype="multipart/form-data">
                    <ul class="forminfo">
                        ...
                        <li><label>市场价格<b>*</b></label>
                            <input name="marketprice" type="text" class="dfinput" value="" style="width:345px;"></li>
                        <li><label>所需积分<b>*</b></label><input name="saleprice" type="text" class="dfinput" value="" style="width:345px;"></li>
