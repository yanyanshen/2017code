...
$(document).ready(function(e) {
    ...
    var getCate=function(pid,name,id){
        $.post('<?php echo U("Pay/Goods/getCateByPid");?>',{pid:pid},function(res){
            if(res.status){
                var str='';
 ...
 /*   getCate(0,'firstCate');*/
    ...
    $.post("<?php echo U('Pay/Goods/brandlist');?>",function(res){
        if(res.status){
...
<body>
 ...
 <form action="<?php echo U('Pay/Goods/editor');?>" id="editor" method="post" enctype="multipart/form-data">
    <ul class="forminfo">
