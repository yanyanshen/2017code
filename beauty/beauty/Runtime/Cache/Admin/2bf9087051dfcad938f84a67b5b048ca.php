...
<body style="background:#f0f9fd;">
    ...
    <!--<dl class="leftmenu">
        ...
        <dd>
            <div class="title">
                <span><img src="/Public/Pay/images/leftico01.png" /></span>品牌管理
            </div>
        	<ul class="menuson">
                <li class="active">
                    <div class="header">
        ...
        <dd>
            ...
            <ul class="menuson">
                <li class="active">
                    <div class="header">
                        <cite></cite>
                        <a href="<?php echo U('Pay/Category/index');?>" target="rightFrame">分类列表</a>
                        <i></i>
                    </div>
                </li>
        ...
        <dd>
            <div class="title">
                <span><img src="/Public/Pay/images/leftico01.png" /></span>商品管理
            </div>
            <ul class="menuson">
                <li class="active">
                    <div class="header">
        ...
        <dd>
            <div class="title">
                <span><img src="/Public/Pay/images/leftico01.png" /></span>会员管理
            </div>
            <ul class="menuson">
                <li class="active">
                    <div class="header">
        ...
        <dd>
            <div class="title">
                <span><img src="/Public/Pay/images/leftico01.png" /></span>订单管理
            </div>
            <ul class="menuson">
                <li class="active">
                    <div class="header">
        ...
        <dd>
            <div class="title">
                <span><img src="/Public/Pay/images/leftico01.png" /></span>广告管理
            </div>
            <ul class="menuson">
                <li class="active">
                    <div class="header">
        ...
        <dd>
            <div class="title">
                <span><img src="/Public/Pay/images/leftico01.png" /></span>活动发布
            </div>
            <ul class="menuson">
                <li class="active">
                    <div class="header">
                        <cite></cite>
                        <a href="<?php echo U('Pay/Sale/index');?>" target="rightFrame">活动列表</a>
                        <i></i>
                    </div>
                </li>
                <li>
                    <div class="header">
                        <cite></cite>
                        <a href="<?php echo U('Pay/Sale/add');?>" target="rightFrame">添加活动</a>
                        <i></i>
                    </div>
                </li>
        ...
        <dd>
            <div class="title">
                <span><img src="/Public/Pay/images/leftico01.png" /></span>评论管理
            </div>
            <ul class="menuson">
                <li class="active">
                    <div class="header">
                        <cite></cite>
                        <a href="<?php echo U('Pay/Comment/index');?>" target="rightFrame">评论列表</a>
                        <i></i>
                    </div>
                </li>
            </ul>
             <ul class="menuson">
                <li class="active">
                    <div class="header">
                        <cite></cite>
                        <a href="<?php echo U('Pay/Comment/index');?>" target="rightFrame">已回复</a>
                        <i></i>
                    </div>
                </li>
            </ul>
             <ul class="menuson">
                <li class="active">
                    <div class="header">
                        <cite></cite>
                        <a href="<?php echo U('Pay/Comment/index');?>" target="rightFrame">未回复</a>
                        <i></i>
                    </div>
                </li>
            </ul>
        ...
        <dd>
            <div class="title">
                <span><img src="/Public/Pay/images/leftico01.png" /></span>反馈管理
            </div>
            <ul class="menuson">
                <li class="active">
                    <div class="header">
                        <cite></cite>
                        <a href="<?php echo U('Pay/Feedback/index');?>" target="rightFrame">反馈列表</a>
                        <i></i>
                    </div>
                </li>
            </ul>
        ...
        <dd>
            <div class="title">
                <span><img src="/Public/Pay/images/leftico01.png" /></span>金币商城
            </div>
            <ul class="menuson">
                <li class="active">
                    <div class="header">
                        <cite></cite>
                        <a href="<?php echo U('Pay/Golds/index');?>" target="rightFrame">商品列表</a>
                        <i></i>
                    </div>
                </li>
                <li class="active">
                    <div class="header">
                        <cite></cite>
                        <a href="<?php echo U('Pay/Golds/addAct');?>" target="rightFrame">添加商品</a>
                        <i></i>
                    </div>
                </li>
            </ul>
    ...
    <dl class="leftmenu" style="height: 20px">
        <?php if(!empty($navList)): if(is_array($navList)): $i = 0; $__LIST__ = $navList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;?><dd>
                    ...
                    <?php if(empty($v1['child'])): ?><a href="<?php echo U($v1['navurl']);?>" target="rightFrame">
                            <div class="title" style="height: 25px;line-height: 25px;">
                                <span >
                                    <img src="/Public/Admin/images/leftico01.png" />
                                </span>
                                <?php echo ($v1["navname"]); ?>
                            </div>
                        </a>
