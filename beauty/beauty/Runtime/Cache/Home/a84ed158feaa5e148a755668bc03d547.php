 ...
 <!--产品列表-->
    <!-- 轮播图-->
     <div class="Product_carousel" id="">
         ...
         <div class="bd">
             <ul>
                 <li><a href="#"><div style="background-image: url(/Public/Home/AD_img/01.jpg);
                 background-repeat:no-repeat; background-position:center;
                 width:100%; height:437px; background-color:#FFF"></div></a></li>
                 <li><a href="#"><div style="background-image: url(/Public/Home/AD_img/AD-112.jpg);
                 background-repeat:no-repeat; background-position:center;  width:100%; height:437px; background-color:#a1e2ff"></div></a></li>
                 <li><a href="#"><div style=" width:100%; background-image: url(/Public/Home/AD_img/AD-111.jpg); background-repeat:no-repeat; background-position:center; height:437px; background-color:#FEF4E8"></div></a></li>
             </ul>
         </div>
