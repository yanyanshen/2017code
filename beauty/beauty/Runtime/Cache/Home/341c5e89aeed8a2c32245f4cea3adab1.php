            ...
            $('#form2').submit(function () {
                $.post("<?php echo U('Member/changePaypwd');?>", $('#form2').serialize(), function (res) {
                    if (res.status == 1) {
                        ...
                        if (res.info == '原有支付密码输入错误') {
                            layer.msg('原有支付密码输入错误', {icon: 5, time: 3000}, function () {
                                location = "<?php echo U('Member/safe');?>"
                            })
                        } else if (res.info == '支付密码修改不允许为空') {
                            layer.msg('支付密码修改不允许为空', {icon: 5, time: 3000}, function () {
                                location = "<?php echo U('Member/safe');?>"
                            })
                        } else {
                            layer.msg('支付密码修改失败', {icon: 5, time: 3000}, function () {
                                location = "<?php echo U('Member/safe');?>"
                            })
                        }
                    }
                ...
                <form id="form2">
                    <table border="0" style="width:880px;"  cellspacing="0" cellpadding="0">
                        ...
                        <tr height="45">
                            ...
                            <td><input type="text" value="" name="newpaypwd" class="add_ipt" style="width:180px;" />&nbsp; <font color="#ff4e00">*</font></td>
                        </tr>
                        <tr height="50">
                            <td>&nbsp;</td>
