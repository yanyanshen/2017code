...
<div class="shoppingMain">
    ...
    <div class="border">
       <!-- <?php echo U('Home/Order/topay');?>-->
        <form action="<?php echo U('Home/Pay/doalipay');?>" method="post" id="pay">
        <div class="myCar">
            <div class="success">
                <h3>订单已提交成功，请尽快付款!</h3>
           ...
           <!-- <input type="submit" value="确认无误，点击支付" name="submit" class="input1" style="margin-left: 250px;" onclick="layerpay()">-->
            <!--<a href="javascript:layerpay();" style="background-color:red;display:inline-block;width: 212px;height: 52px;color:#ffffff;text-align: center;line-height: 52px;margin-left: 250px;font-weight: bold;font-size: 14px;">-->
                <!--确认无误，点击支付-->
            <!--</a>-->
            <a href="" style="background-color:red;display:inline-block;width: 212px;height: 52px;color:#ffffff;text-align: center;line-height: 52px;margin-left: 250px;font-weight: bold;font-size: 14px;">

                <input type="submit"  value="确认无误，点击支付121"/>
            </a>
