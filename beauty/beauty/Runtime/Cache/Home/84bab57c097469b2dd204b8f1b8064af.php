...
<div class="i_bg bg_color">
    ...
    <div class="m_content" style="margin: 0 auto">
        <div class="m_left">
            ...
            <div class="left_m">
                ...
                <ul>
                    ...
                    <li><a href="<?php echo U('Home/Member/Orderform1');?>" class="now">金币兑换订单</a></li>
        ...
        <div class="m_right">
            <div>
                <form action="<?php echo U('Home/Member/orderform1');?>" method="get">
                    <ul class="seachform">
                ...
                <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($k % 2 );++$k;?><tr>
                        ...
                        <td>
                            <?php switch($val["memberstatus"]): case "付款": ?><a href="<?php echo U('Home/Member/topay1',array('oid'=>$val['id']));?>">付款</a>
                                ...
                                <?php case "确认收货": ?><a href="<?php echo U('Home/Member/confirm_goods1',array('oid'=>$val['id'],'gid'=>$val['gid']));?>">确认收货</a><?php break;?>
                                <?php case "交易完成": ?><a href="#">交易完成</a><?php break;?>
                                <?php case "评价": ?><a href="<?php echo U('Home/Member/usercomment1',array('oid'=>$val['id'],'gid'=>$val['gid']));?>">评价</a><?php break;?>
                                <?php case "追加评价": ?><a href="#">追加评价</a><?php break; endswitch;?>
                        </td>
