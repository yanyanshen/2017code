        ...
        <div class="m_right">
            <div class="m_des">
                <table border="0" style="width:870px; line-height:22px;" cellspacing="0" cellpadding="0">
                    <tr valign="top">
                        <td width="115"><img src="/UserImg/photo<?php echo ($savepath); echo ($savename); ?>" width="90" height="90" id="photo"/>
                            <a href="<?php echo U('addImg');?>" style="color: orange; cursor: pointer; display: block;margin-left: -10px " >点击更换头像</a></td>
                        <td>
