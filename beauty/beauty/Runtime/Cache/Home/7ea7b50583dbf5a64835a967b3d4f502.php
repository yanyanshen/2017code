	...
	<div class="m_content" style="margin: 0 auto">
		...
		<div class="m_right">
			...
			<table  class="ma_tab" border="0" style="width:930px; text-align:center; margin-bottom:30px;border: 1px solid red" cellspacing="0" cellpadding="0">
                <tr>
              	<td class="ma_a" colspan="7" align="right"><a href="<?php echo U('Member/recharge');?>">充值</a>|<a href="<?php echo U('Member/drawcash');?>">提现</a>|<a href="<?php echo U('Member/chargeRecord');?>">查看充值记录</a></td>
              </tr>
              <tr>
                <td width="45">编号</td>
              ...
              <tr>
                <td colspan="7" align="right">您当前的可用资金为：<span class="list">￥ <?php echo ($balance); ?></span></td>
              </tr>
                </volist>
