    ...
    <style>
        ...
        <script>
            ...
            $('#send-btn').click(function(){
                    ...
                    if(validate.form()){
                        $.post("<?php echo U('Register/register');?>",$('#form1').serialize(),function(res){
                            if(res.status==1){
                                layer.open({
                                    content : res.info,
                                    icon : 1,
...
<div class="top">
  ...
  <div class="regist">
    ...
    <div class="reg_c" id="registered">
      ...
      <div class="bd">
        <ul>
        <form id="form1" action="<?php echo U('Register');?>" method="post" name="loginForm">
            <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
              <tbody><tr height="50" valign="top">
              	<td width="95">&nbsp;</td>
                <td>
                	<span class="fl" style="font-size:24px;">注册</span>
                    <span class="fr">已有商城账号，<a href="<?php echo U('Login/Login');?>" style="color:#ff4e00;">我要登录</a></span>
                </td>
              </tr>
              <tr height="50">
              ...
              <tr height="50">
                ...
                <td>
                    ...
                    <img  src="<?php echo U('verify');?>" alt="验证码" onclick="this.src='<?php echo U('verify?vid=1',array('id',mt_rand()));?>'" style="cursor: pointer;width:80px;height:40px;display: inline-block; position:relative;top: 15px;left: -4px"/>
