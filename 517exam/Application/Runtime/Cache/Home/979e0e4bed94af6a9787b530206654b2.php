            ...
            <div class="container">
                ...
                <div id="bd" class="panel">
                    <div id="panel1" class="panel-body">
                        <form action='<?php echo U("Home/Index/short_detail");?>' id="form1" method="post">
                            ...
                            <div class="buttons">
                                <input class="btn btn-lg btn-success start_exam"  onclick="check()"  type="submit" value="点击查看" style="color:#fdfd88;width: 100%;margin-top:10px;"/>
