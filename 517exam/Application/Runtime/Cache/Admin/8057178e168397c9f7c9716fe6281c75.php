                                    ...
                                    <div style="width:  500px;">
                                        <dl>
                                            <dd>
                                                参考答案
                                                &nbsp;&nbsp;
                                                <?php if($correct_papers == 0): ?><input type="text" name="<?php echo ($data["id"]); ?>[]" value="" placeholder="请输入您给的分值" style="margin-bottom: 2px;margin-left:20px;border: double #808080"/>
                                                    <?php elseif($correct_papers == 1): ?>
                                                    <input type="text" name="<?php echo ($data["id"]); ?>[]" value="<?php echo ($data['info']['score']); ?>" placeholder="请输入您给的分值" style="margin-bottom: 2px;margin-left:20px;border: double #808080"/><?php endif; ?>
                                            </dd>
                                            <dd>
