...
<script language="JavaScript" src="/test/Public/Admin/js/jquery.min.1.8.2.js"></script>
<script src="/test/Public/Admin/js/jquery.min.1.8.2.js"></script>
<script src="/test/Public/Admin/js/cloud.js" type="text/javascript"></script>
<script src="/test/Public/Admin/js/jquery.validate.js"></script>
...
<script language="javascript">
	$(function(){
        ...
        $('#form1').submit(function(){
            if(validate.form()){
                $.post("<?php echo U('Pay/Login/Login');?>",$('#form1').serialize(),function(res){
                    if(res.status==1){
                       layer.msg('登陆成功',{time:2000,icon:6},function(){
                           window.location.href="<?php echo U('Pay/Index/index');?>";
                       })
                    }else{
                        layer.msg(res.info,{time:2000,icon:5},function() {
                            window.location.href="<?php echo U('Pay/Login/Login');?>";
                        })
                    }
                },'json');
                return false;
...
<body style="background-color:#1c77ac; background-image:url(/test/Public/Admin/images/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;" id="body" onLoad="init()">
<div id="mainBody">
...
<script type="text/javascript" src="/test/Public/Admin/js/ThreeCanvas.js"></script>
<script type="text/javascript" src="/test/Public/Admin/js/Snow.js"></script>
...
<script type="text/javascript">
    ...
    particleImage.src = '/test/Public/Pay/images/ParticleSmoke.png';
